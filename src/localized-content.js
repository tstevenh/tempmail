...
function legal(locale, slug) {
  ...
  const maps = {
    de: {
      ...
      "/contact": "Fragen, Feedback, Partnerschaften oder Missbrauchsmeldungen können an support@opentempmail.com gesendet werden. Für Datenschutzfragen lesen Sie bitte die Datenschutzerklärung.",
    ...
    fr: {
      ...
      "/contact": "Questions, retours, partenariats ou signalements d’abus peuvent être envoyés à support@opentempmail.com.",
    ...
    es: {
      ...
      "/contact": "Preguntas, comentarios, colaboraciones o reportes de abuso pueden enviarse a support@opentempmail.com.",
    ...
    nl: {
      ...
      "/contact": "Vragen, feedback, partnerschappen of misbruikmeldingen kunnen naar support@opentempmail.com worden gestuurd.",
    ...
    it: {
      ...
      "/contact": "Domande, feedback, partnership o segnalazioni di abuso possono essere inviati a support@opentempmail.com.",
